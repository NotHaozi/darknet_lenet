...
# NOTE: 这里原作者搞反了，改正
conv_mnist("t10k-images-idx3-ubyte",
           "t10k-labels-idx1-ubyte", 10000, img_path+"/test")
conv_mnist("train-images-idx3-ubyte",
           "train-labels-idx1-ubyte", 60000, img_path+"/train")
